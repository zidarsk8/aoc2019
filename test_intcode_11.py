...
def test_multiple_steps():
    robot = Robot(robot_brain)
    robot.brain = Mock()
    robot.brain.run_partial.side_effect = [
        (1, True),
        (0, True),
        (0, True),
        (0, True),
